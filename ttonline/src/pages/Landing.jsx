        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-700 mb-6">
              Discover the importance of gender equality in the workplace and its
              impact on individuals and organizations. Join us in creating a world
              with equal pay, equal opportunities, and equal outcomes.
            </p>
            <Link
              to="/about"
